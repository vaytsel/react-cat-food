...
function FoodListItem(props) {
    ...
    return (
        <li className={classNames} onMouseLeave={() => setMouseLeave(true)} onMouseEnter={() => setMouseLeave(false)}>
            ...
            <div className="food-list-item__main" onClick={props.disabled ? '' : props.onSelected}>
                <Head mouseLeave={mouseLeave} selected={props.selected} />
            ...
            <div className="food-list-item__desc text-center">
                {descText}
                <BuyLink disabled={props.disabled} selected={props.selected} onSelected={props.onSelected} />
            </div>
        </li>
    );
}
